...
def main():
    ...
    writer = ch_writer()
    writer.write_to_clickhouse(sum_transactions, table_name="sum_transactions", order_by_cols="type, sales_id, branch_id, employee_id", mode="overwrite")
