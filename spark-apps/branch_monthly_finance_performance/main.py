...
from branch_monthly_finance_performance.sql import process_branch_montlhy_finance_performance
...
def main():
    spark = SparkSession.builder \
        .appName("branch_monthly_finance_performance") \
        .getOrCreate()
    ...
    print("Execution branch_monthly_finance_performance")
    branch_monthly_finance_performance = process_branch_montlhy_finance_performance(spark)
    branch_monthly_finance_performance.printSchema()
    branch_monthly_finance_performance.show()

    writer = ch_writer()
    writer.write_to_clickhouse(branch_monthly_finance_performance, table_name="branch_monthly_finance_performance", order_by_cols="name,month", mode="overwrite")
