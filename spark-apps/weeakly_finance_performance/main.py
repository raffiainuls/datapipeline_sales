...
from weeakly_finance_performance.sql import process_weekly_finance_performance
...
def main():
    spark = SparkSession.builder \
        .appName("weeakly_finance_performance") \
        .getOrCreate()
    ...
    print("Execution weeakly_finance_performance")
    weeakly_finance_performance = process_weekly_finance_performance(spark)
    weeakly_finance_performance.printSchema()
    weeakly_finance_performance.show(truncate=False, n=20)

    writer = ch_writer()
    writer.write_to_clickhouse(weeakly_finance_performance, table_name="weeakly_finance_performance", order_by_cols="week", mode="overwrite")
