...
from branch_finance_performance.sql import process_branch_finance_performance
...
def main():
    spark = SparkSession.builder \
        .appName("branch_finance_performance") \
        .getOrCreate()
    ...
    print("Execution branch_finance_performance")
    branch_finance_performance = process_branch_finance_performance(spark)
    branch_finance_performance.printSchema()
    branch_finance_performance.show(truncate=False, n=20)

    writer = ch_writer()
    writer.write_to_clickhouse(branch_finance_performance, table_name="branch_finance_performance", order_by_cols="name", mode="overwrite")
