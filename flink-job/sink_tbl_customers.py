...
from tbl_branch.lib import create_print_table, create_sink_table, create_source_table,set_insert_sql


def main():
    source_table = "tbl_customers_hadoop"
    sink_table = "hdfs_sink_tbl_customers"
    print_table = "print_table_tbl_customers"
    topic = "source-postgres2.public.tbl_customers"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_customers/parquet'
