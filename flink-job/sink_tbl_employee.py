...
from tbl_employee.lib import create_print_table, create_sink_table, create_source_table,set_insert_sql


def main():
    source_table = "tbl_employee_hadoop"
    sink_table = "hdfs_sink_tbl_employee"
    print_table = "print_table_tbl_employee"
    topic = "source-postgres.public.tbl_employee"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_employee/parquet'
