...
def main():
    source_table = "tbl_product_hadoop"
    sink_table = "hdfs_sink_tbl_product"
    print_table = "print_table_tbl_poduct"
    topic = "source-postgres.public.tbl_product"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_product/parquet'
