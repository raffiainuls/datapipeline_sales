...
from tbl_payment_method.lib import create_print_table, create_sink_table, create_source_table,set_insert_sql


def main():
    source_table = "tbl_payment_method_hadoop"
    sink_table = "hdfs_sink_tbl_payment_method"
    print_table = "print_table_tbl_payment_method"
    topic = "source-postgres.public.tbl_payment_method"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_payment_method/parquet'
