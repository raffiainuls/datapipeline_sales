...
from tbl_shipping_status.lib import create_print_table, create_sink_table, create_source_table,set_insert_sql


def main():
    source_table = "tbl_shipping_status_hadoop"
    sink_table = "hdfs_sink_tbl_shipping_status"
    print_table = "print_table_tbl_shipping_status"
    topic = "source-postgres.public.tbl_shipping_status"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_shipping_status/parquet'
