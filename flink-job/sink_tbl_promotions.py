...
from tbl_promotions.lib import create_print_table, create_sink_table, create_source_table,set_insert_sql


def main():
    source_table = "tbl_promotions_hadoop"
    sink_table = "hdfs_sink_tbl_promotions"
    print_table = "print_table_tbl_promotions"
    topic = "source-postgres.public.tbl_promotions"
    bootstrap_servers = "host.docker.internal:9093"
    file_path = 'hdfs://namenode:8020/data/landing/tbl_promotions/parquet'
